...
public class StatController {
    ...
    String statPage(Model model) {
        List<SelectedColor> selectedColor = selectedColorService.getAllData();
        Map<String, Long> dataMap = selectedColor.stream().collect(Collectors.groupingBy(SelectedColor::getColor, Collectors.counting()));
        ...
        model.addAttribute("background", ColorHelper.convertColors(dataMap.keySet()));
